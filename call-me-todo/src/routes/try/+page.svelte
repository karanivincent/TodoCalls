		...
		<div class="py-16">
			<div class="text-center">
				...
				<p class="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
					Never miss a task again. Get automated phone call reminders for your important todos.
				</p>
				...
				<div class="mt-10 grid grid-cols-1 gap-8 sm:grid-cols-3">
					<div class="text-center">
						...
						<p class="mt-2 text-base text-gray-500">
							Add your task with a phone number and scheduled time
						</p>
					</div>
					<div class="text-center">
						<div class="flex items-center justify-center h-12 w-12 rounded-md bg-orange-500 text-white mx-auto">
						...
						<p class="mt-2 text-base text-gray-500">
							Receive an automated phone call at your scheduled time
						</p>
					</div>
					<div class="text-center">
						<div class="flex items-center justify-center h-12 w-12 rounded-md bg-orange-500 text-white mx-auto">
						...
						<p class="mt-2 text-base text-gray-500">
							Press 1 to mark complete or 2 to snooze for 10 minutes
						</p>
					</div>
				</div>
			</div>
